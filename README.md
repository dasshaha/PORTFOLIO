...
### **Tech stack:**
`HTML5`, `CSS3`, `JavaScript (ES6+)`, `Leaflet.js`, `Local Storage API`, `Figma`, `Git`

### **Next steps:**
I plan to **refactor the project to React** for better code structure, develop the **backend part with Node.js/Express**, and integrate **AI** for generating unique routes.
